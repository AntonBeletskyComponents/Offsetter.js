...
const Offsetter = (() => {
     ...
     * Catches height changes that ResizeObserver cannot detect:
     * CSS transitions, collapsing accordions, font-face loading.
     * @type {number|null}
     */
    ...
    return {
        ...
        init(options = {}) {
            ...
            // Polling fallback — catches what ResizeObserver misses:
            // CSS max-height transitions, accordion collapses, font loading.
